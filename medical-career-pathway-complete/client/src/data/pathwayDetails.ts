      ...
      },
      {
        ...
        itemsAr: [
          ...
          "الطب النفسي - تنافسية متوسطة وتميل للارتفاع السريع. لم يعد تخصصاً سهلاً كما في السابق، لكنه يظل قابلاً للوصول بنسبة قبول للأطباء الأجانب تبلغ 10% إلى 12%",
           "نسبة قبول الأطباء الأجانب بشكل عام: التخصصات الجراحية والدقيقة مثل الجلدية والعظام أقل من 3% — التخصصات متوسطة وعالية التنافسية مثل الأشعة والجراحة العامة من 5% إلى 12% — التخصصات الصديقة للأجانب مثل الباطني وطب الأطفال من 15% إلى 30% أو أكثر"
        ]
      }
    ]
  }
