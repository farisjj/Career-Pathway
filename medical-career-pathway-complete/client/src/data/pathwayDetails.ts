    ...
    content: [
      ...
      },
      {
        ...
        itemsAr: [
          ...
          "نسبة قبول الأطباء الأجانب بشكل عام:
          التخصصات الجراحية والدقيقة (كالجلدية والعظام): أقل من 3%.
          التخصصات متوسطة وعالية التنافسية (كالأشعة والجراحة العامة): من 5% إلى 12%.
          التخصصات الصديقة للأجانب (كالباطني وطب الأطفال): من 15% إلى 30% أو أكثر."
        ]
      }
    ]
  }
