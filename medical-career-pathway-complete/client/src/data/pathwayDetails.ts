  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        itemsAr: [
          "الجراحة العامة - تنافسية جداً",
          "طب الأطفال - تنافسية عالية",
          "الأمراض الجلدية - التنافسية فائقة جداً. نسبة الأطباء الدوليين (Non-US IMGs) المقبولين سنوياً تكاد لا تتجاوز 1% إلى 2% من إجمالي المقاعد (عدد المقبولين في كل أمريكا يُعد على أصابع اليدين، وأحياناً أقل من 5 أطباء أجانب في السنة). يتطلب القبول درجات استثنائية، وسنوات من الأبحاث السريرية داخل أمريكا، وشبكة علاقات (Connections) قوية جداً.",
          "الأشعة - تنافسية عالية",
          "الطب النفسي - أقل تنافسية",
          "نسبة قبول الأطباء الأجانب: 10-15% في التخصصات التنافسية"
        ]
      }
    ]
  }
